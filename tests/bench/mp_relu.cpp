...
int main(int __argc, char**__argv){
    ...
    u64 num_samples = 1000;//19717*256;  //3327*256; //2708*256;
    ...
    FSS::start();
    // SlothRelu(num_samples, 64, input.data, output.data, "sloth_relu_");
    // FastSecNetRelu(num_samples, input.data, input.data, output.data);
    NewRelu(num_samples, 64, input.data, output.data, "sloth_relu_"); 
